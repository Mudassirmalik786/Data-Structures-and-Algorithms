...
class Mainwindow(QMainWindow):
    def __init__(self):
        ...
        loadUi("E:\DSA_LABS\DSA_Lab5\CRUD\scrape.ui",self) # Here we imported the QT Designer file which we made as Python GUI FIle.
    ...
    def Check_regNo(self,reg): 
        print(reg)
        with open('E:\DSA_LABS\DSA_Lab5\CRUD\student.csv', 'r',encoding="utf-8",newline="") as fileInput:
    ...
    def Add_student(self):
        ...
        if(regNo != "Registration Number" and self.Check_regNo(regNo)):
            ...
            with open('E:\DSA_LABS\DSA_Lab5\CRUD\student.csv', 'a+',encoding="utf-8",newline="") as fileInput:
    ...
    def edit_student(self):
        ...
        index_student = None
        updated_data = []
        with open('E:\DSA_LABS\DSA_Lab5\CRUD\student.csv', "r", encoding="utf-8") as fileInput:
        ...
        if student_found is True:
            ...
            with open('E:\DSA_LABS\DSA_Lab5\CRUD\student.csv', "w", encoding="utf-8",newline="") as fileInput:
                writer = csv.writer(fileInput)
